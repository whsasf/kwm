...
<div class="url-url-select ivu-select ivu-select-visible ivu-select-single ivu-select-default" style="position: relative">
    <i-input v-model="searchItem" :clearable="true" search placeholder="输入关键词进行模糊查询" @on-change="stopWordsSearch" @on-search="batchSearch" @on-clear="resetInput" />
